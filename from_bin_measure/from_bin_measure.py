...
# 配置文件路径
# image_path = os.path.join(os.getcwd(),"5857/input/image_00012.jpg")
# images_bin_path = os.path.join(os.getcwd(),"5857/sparse/0/images.bin")
# points3D_bin_path = os.path.join(os.getcwd(),"5857/sparse/0/points3D.bin")
image_path = "image_00012.jpg"
